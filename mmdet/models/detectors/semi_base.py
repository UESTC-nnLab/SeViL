...
class SemiBaseDetector(BaseDetector):
    ...
    def get_pseudo_instances(
        ...
        self.teacher.eval()
        features, txt_fea = self.teacher.extract_feat(batch_inputs) # batch_inputs[3,5,3,512,512] features[3,256,64,64] -- 4 4
        ...
        return batch_data_samples, batch_info,features,txt_fea
    ...
    def project_pseudo_instances(self, batch_pseudo_instances: SampleList,
        ...
        wh_thr = self.semi_train_cfg.get('min_pseudo_bbox_wh', (1, 1))
...
#         loss = F.l1_loss(weighted_feats, visual_feats)
#         return loss
