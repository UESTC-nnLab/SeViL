...
train_cfg = dict(
    type='IterBasedTrainLoop', max_iters=180000, val_interval=2000,val_begin = 3000) #,val_begin = 3000
...
default_hooks = dict(
    checkpoint=dict(by_epoch=False, interval=500, max_keep_ckpts=2,save_best='student/coco/bbox_mAP_50',  # 按照该指标保存最优模型
        type='CheckpointHook'),
