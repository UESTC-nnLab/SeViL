...
def parse_args():
    ...
    parser.add_argument(     # /home/public/DAUB/images/test/data20/36.bmp #/home/public/ITSDT/images/84/35.bmp  /home/public/IRDST/real/images/24/38.bmp
        '--inputs', type=str, default='/home/public/IRDST/real/images/92/1010.bmp', help='Input image file or folder path.') 
    parser.add_argument(
        '--model',
        type=str,
        default='/home/dww/OD/semi-txt/projects/MixPL/myconfig/stxt/mixpl_tood_irdst.py',
        help='Config or checkpoint .pth file or the model name '
        'and alias defined in metafile. The model configuration '
        'file will try to read from .pth if the parameter is '
        'a .pth weights file.')
    parser.add_argument('--weights', default='/home/dww/OD/semi-txt/work_dirs/mixpl_tood_irdst/20241130_200626/best_student_coco_bbox_mAP_50_iter_19000.pth', help='Checkpoint file')
    parser.add_argument(
        '--out-dir',
        type=str,
        default='outputs',
